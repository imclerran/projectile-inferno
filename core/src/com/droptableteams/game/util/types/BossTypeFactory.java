...
public class BossTypeFactory {
    ...
    public static BossType makeMidBoss() {
        ...
        return new BossType("BossEntity", "midBoss",fpd, 52, 52, 128, 100, true, false,"sprites/bossA.png");
    }
    ...
    public static BossType makeFinalBoss() {
        ...
        return new BossType("BossEntity", "finalBoss",fpd, 52, 52, 128, 100, true, false,"sprites/bossB.png");
    }
